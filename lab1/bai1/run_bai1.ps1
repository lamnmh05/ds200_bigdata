...
# ========= CONFIG =========
$PROJECT_DIR = "D:\Git_repo\DS200_BIGDATA\lab1\bai1"
$SRC_FILE    = Join-Path $PROJECT_DIR "MovieRatingAnalysis.java"
$CLASS_DIR   = Join-Path $PROJECT_DIR "build_classes"
$JAR_FILE    = Join-Path $PROJECT_DIR "MovieRatingAnalysis.jar"
...
jar -cvf "MovieRatingAnalysis.jar" -C "build_classes" .
Pop-Location
...
hadoop jar $JAR_FILE MovieRatingAnalysis $LOCAL_INPUT_DIR $LOCAL_OUTPUT_DIR $LOCAL_MOVIES_FILE
