...
# ========= CONFIG =========
$PROJECT_DIR = "D:\Git_repo\DS200_BIGDATA\lab1\bai4"
$SRC_FILE    = Join-Path $PROJECT_DIR "AgeGroupRatingAnalysis.java"
$CLASS_DIR   = Join-Path $PROJECT_DIR "build_classes"
$JAR_FILE    = Join-Path $PROJECT_DIR "AgeGroupRatingAnalysis.jar"
...
jar -cvf "AgeGroupRatingAnalysis.jar" -C "build_classes" .
Pop-Location
...
hadoop jar $JAR_FILE AgeGroupRatingAnalysis $LOCAL_INPUT_DIR $LOCAL_OUTPUT_DIR $LOCAL_MOVIES_FILE $LOCAL_USERS_FILE
